    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (isTitled) {
            ...
            if (titleText != null) {
                ...
                holder.binding.tvTitle.setText("Мы что-то напутали, извините за неудобства!\n" +
        ...
        if (releaseDate > 0) {
            ...
            holder.binding.tvReleaseNote.setText("Дата выпуска:" + formatter.format(new Date(releaseDate)));
        } else {
        ...
        if (description != null) {
            ...
            holder.binding.tvSubTitle.setText("Мы что-то напутали, извините за неудобства!\n" +
